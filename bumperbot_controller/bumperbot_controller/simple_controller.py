...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Using wheel radius (Wr): %d" % self.wheel_radius_)
        self.get_logger().info("Using wheel separation(Ws): %d" % self.wheel_separation_)
    ...
    def jointCallback(self, msg):
        ...
        # Calculation of rotational speed of each wheel
        fi_left = dp_left/(dt.nanoseconds/S_TO_NS)
        fi_right = dp_right/(dt.nanoseconds/S_TO_NS)
        
        # Calculation of Linear and Angular Velocity
